    ...
    return (
        <>
            {isPrimary ? (
                ...
                <button
                    className={`px-6 py-2 bg-white dark:bg-ourBlack border border-white dark:border-ourBlack text-ourRed hover:text-ourDarkRed hover:border-bg-red-700 hover:border-red-700 ${
                        bigText ? "text-md" : "text-[0.65rem]"
